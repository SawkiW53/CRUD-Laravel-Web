...
@section('content')
<div class="hero" style="background-image: url('{{ asset('frontend/images/wall1.jpg') }}')">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-10">
              <div class="row mb-5">
                <div class="col-lg-7 intro">
                  <h1 style="color: white;"><strong>Sewa Mobil Impianmu</strong> dengan mudah pasti amanah</h1>
                </div>
              </div>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Pilih Mobil</h3>
                  <p>
                    PIlihlah mobil yang kamu suka buat disewa biar kelihatan kaya
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Isi Form</h3>
                  <p>
                    Isi data dirimu nanti kami kontak dan lanjut di Whatsapp
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Pembayaran</h3>
                  <p>
                    Setelah fix menyewa jangan lupa bayar bisa cash dan trasfer tergantung kamu
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 ml-auto order-lg-1">
              <h3 class="mb-4 section-heading">
                <strong
                  >Memberikan anda kesempatan untuk mencicipi mobil Mewah</strong
                >
              </h3>
              <p class="mb-5">
                Pelayanan terbaik dan banyak pilihan mobil yang kami sediakan untuk kamu
                Bisa pakai untuk flexing biar kelihatan kaya
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7">
              ...
              <p class="mb-5">
                Pilih mobil sesuai keinginan atau kebutuhanmu
              </p>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7">
              ...
              <p class="mb-5">
                Hasil testi terpercaya no Setinggan
              </p>
            </div>
          </div>
          <div class="row">
